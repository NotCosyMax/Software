...
typedef struct
{
  ...
  int8   *iSamples;               //!< list of I samples
  int8   *qSamples;               //!< list of Q samples  
...
typedef struct
{
  ...
  void   *iSamples;               //!< list of I samples (list size is dataLen)
  void   *qSamples;               //!< list of Q samples (list size is dataLen)
